...
public class ExcelDeptHistoryVO {
     ...
     * 유효시작일자
     */
    @ColumnAttribute(Index = 12, Title = "이력시작일",   ColumnWidth = 120, CellStyleMethodName = "Content")
    private String avlStartDate;

    /**
     * 유효종료일자
     */
    @ColumnAttribute(Index = 13, Title = "이력종료일",   ColumnWidth = 120, CellStyleMethodName = "Content")
     ...
     * 조직생성일
     */
    @ColumnAttribute(Index = 14, Title = "조직생성일",   ColumnWidth = 120, CellStyleMethodName = "Content")
    private String orgCrtDate;

    /**
     * 조직폐쇄일
     */
    @ColumnAttribute(Index = 15, Title = "조직폐쇄일",   ColumnWidth = 120, CellStyleMethodName = "Content")
    ...
    public String toString() {
        return "ExcelDeptChgHisVO [deptId=" + deptId + ", deptNm=" + deptNm + ", hgrkDeptId="
                + hgrkDeptId + ", hgrkDeptNm=" + hgrkDeptNm + ", deptSortSeqc=" + deptSortSeqc
                + ", deptLvlCd=" + deptLvlCd + ", deptLvlCdNm=" + deptLvlCdNm + ", hddpEmpId=" + hddpEmpId
                + ", hddpEmpNm=" + hddpEmpNm + ", ofpsCdNm=" + ofpsCdNm + ", sellOcrYn=" + sellOcrYn + ", orgCrtDate="
                + orgCrtDate + ", orgCloseDate=" + orgCloseDate + ", avlStartDate=" + avlStartDate + ", avlEndDate="
                + avlEndDate + "]";
    }
