...
public class ExcelCostCenterVO {
    //@ColumnAttribute(Index = 0, Title = "번호", IsRowMerge = true, ColumnWidth = 50, CellStyleMethodName = "Content")
    //private Long no;
    /**
     * 코스트센터 ID
     */
    @ColumnAttribute(Index = 0, Title = "코스트센터ID",   ColumnWidth = 110, CellStyleMethodName = "Content")
    private String ccId;
     ...
     * 상위코스트센터ID
     */
    @ColumnAttribute(Index = 2, Title = "상위코스트센터ID",   ColumnWidth = 120, CellStyleMethodName = "Content")
     ...
     * 유효시작일자
     */
    @ColumnAttribute(Index = 5, Title = "유효시작일자",   ColumnWidth = 120, CellStyleMethodName = "Content")
    private String avlStartDate;

    /**
     * 유효종료일자
     */
    @ColumnAttribute(Index = 6, Title = "유효종료일자",   ColumnWidth = 120, CellStyleMethodName = "Content")
    private String avlEndDate;

    /**
     * 조직생성일자
     */
    @ColumnAttribute(Index = 7, Title = "조직생성일자",   ColumnWidth = 120, CellStyleMethodName = "Content")
    private String orgCrtDate;

    /**
     * 조직종료일자
     */
    @ColumnAttribute(Index = 8, Title = "조직종료일자",   ColumnWidth = 120, CellStyleMethodName = "Content")
