...
public class EmployeeResultIFVO {
    /**
     * 전송상태
     */
    private String sndJobCd;
     ...
     * 배치작업결과코드
     */
    private String btjbRstCd;

    /**
     * 배치작업결과메시지
     */
    private String btjbMsgCont;


    /**
     * default 패스워드 (chrlqlqjs@#!8)
     */
    private String defaultGWPW;
     ...
     * 소속회사코드
     */
    private String bltoCompCd;

    /**
     * 소속회사명
     */
    private String bltoCompNm;
    ...
    public String getSndJobCd() {
        return sndJobCd;
    }

    public void setSndJobCd(String sndJobCd) {
        this.sndJobCd = sndJobCd;
    }
    ...
    public String getBtjbRstCd() {
        return btjbRstCd;
    }

    public void setBtjbRstCd(String btjbRstCd) {
        this.btjbRstCd = btjbRstCd;
    }

    public String getBtjbMsgCont() {
        return btjbMsgCont;
    }

    public void setBtjbMsgCont(String btjbMsgCont) {
        this.btjbMsgCont = btjbMsgCont;
    }

    public String getDefaultGWPW() {
        return defaultGWPW;
    }

    public void setDefaultGWPW(String defaultGWPW) {
        this.defaultGWPW = defaultGWPW;
    }
    ...
    public String getBltoCompCd() {
        return bltoCompCd;
    }

    public void setBltoCompCd(String bltoCompCd) {
        this.bltoCompCd = bltoCompCd;
    }

    public String getBltoCompNm() {
        return bltoCompNm;
    }

    public void setBltoCompNm(String bltoCompNm) {
        this.bltoCompNm = bltoCompNm;
    }
